...
HD_PWD='/home/smarumot/alveo_firm/kernel_design/fw_sl2/project_1/project_1.runs/LUT_ptTDP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT_ptTDP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT_ptTDP.tcl

...
HD_PWD='/home/smarumot/alveo_firm/kernel_design/fw_sl2/project_1/project_1.runs/LUT13TDP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT13TDP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT13TDP.tcl

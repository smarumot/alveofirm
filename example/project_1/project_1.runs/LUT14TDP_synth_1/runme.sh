...
HD_PWD='/home/smarumot/alveo_firm/kernel_design/fw_sl2/project_1/project_1.runs/LUT14TDP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT14TDP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT14TDP.tcl

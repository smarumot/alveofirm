...
HD_PWD='/home/smarumot/alveo_firm/kernel_design/fw_sl2/project_1/project_1.runs/dcm40_to_320_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dcm40_to_320.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dcm40_to_320.tcl

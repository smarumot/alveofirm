...
--               /home/smarumot/alveo_firm/kernel_design/fw_sl2/project_1/project_1.gen/sources_1/ip/dcm40_to_320/dcm40_to_320_sim_netlist.vhdl
-- Design      : dcm40_to_320
...
entity dcm40_to_320_clk_wiz is
  port (
...
end dcm40_to_320_clk_wiz;

architecture STRUCTURE of dcm40_to_320_clk_wiz is
...
entity dcm40_to_320 is
  ...
  attribute NotValidForBitStream of dcm40_to_320 : entity is true;
end dcm40_to_320;

architecture STRUCTURE of dcm40_to_320 is
begin
inst: entity work.dcm40_to_320_clk_wiz
     port map (
      clk320 => clk320,
      clk_in => clk_in,
      locked => locked,

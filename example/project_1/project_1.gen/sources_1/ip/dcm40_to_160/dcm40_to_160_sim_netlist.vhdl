...
-- Date        : Tue Jan 24 19:16:08 2023
-- Host        : accel1 running 64-bit CentOS Linux release 7.9.2009 (Core)
-- Command     : write_vhdl -force -mode funcsim
--               /home/smarumot/alveo_firm/kernel_design/fw_sl2/project_1/project_1.gen/sources_1/ip/dcm40_to_160/dcm40_to_160_sim_netlist.vhdl
-- Design      : dcm40_to_160
...
entity dcm40_to_160_clk_wiz is
  port (
...
end dcm40_to_160_clk_wiz;

architecture STRUCTURE of dcm40_to_160_clk_wiz is
  signal clk160_dcm40_to_160 : STD_LOGIC;
  signal clk_in_dcm40_to_160 : STD_LOGIC;
  signal clkfbout_buf_dcm40_to_160 : STD_LOGIC;
  signal clkfbout_dcm40_to_160 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_dcm40_to_160,
      O => clkfbout_buf_dcm40_to_160
    );
...
entity dcm40_to_160 is
  ...
  attribute NotValidForBitStream of dcm40_to_160 : entity is true;
end dcm40_to_160;

architecture STRUCTURE of dcm40_to_160 is
begin
inst: entity work.dcm40_to_160_clk_wiz
     port map (
      clk160 => clk160,
      clk_in => clk_in,
      locked => locked,

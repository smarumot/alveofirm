...
(
  ...
  input  wire signed [C_M00_AXI_DATA_WIDTH-1:0]   m00_axi_rdata  ,
  ...
  output wire signed [C_M02_AXI_DATA_WIDTH-1:0]   m02_axi_wdata  ,
...
localparam integer  LP_DEFAULT_LENGTH_IN_BYTES = 32768;

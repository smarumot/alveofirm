...
(
  ...
  output wire signed [C_M_AXI_DATA_WIDTH-1:0]          m_axi_wdata        ,
  ...
  input wire [C_M_AXI_ADDR_WIDTH-1:0]           ctrl_addr_out_offset   ,
  ...
  input wire signed [C_M_AXI_DATA_WIDTH-1:0]           a_rd_tdata
);
...
logic                          adder_tvalid;
logic                          adder_tready;
logic signed [C_M_AXI_DATA_WIDTH-1:0] adder_tdata;
...
AXI_write (
  ...
  .ctrl_addr_offset        ( ctrl_addr_out_offset        ) ,
  .ctrl_xfer_size_in_bytes ( ctrl_xfer_size_in_bytes ) ,
